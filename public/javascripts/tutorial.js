...
var scripts = [
    ...
    [10, ['speak', {player: 1, content: "这回合我要到4号线索房间里去找出线索，并且拿到房间里面的锁匙，请大家不要来争夺，拿到锁匙的下一回合我将去解锁7号房间。"}]],
    ...
    [5, ['speak', {player: 5, content: "... ,我什么都不知道我要听下大家的发言才能决定我的行动。"}]],
    [1, ['update', {"round":1,"stage":"speak","room":0,"player":5,"time":70,"bomb":0}]],
    [4, ['speak', {player: 6, content: "2号你要去拆弹吗? 那你到哪一个房间里呢?"}]],
    [8, ['notice', "游戏过程中，所有玩家按照顺序发言，无法交谈、问答。2号玩家此时无法回应6号玩家，也禁止一切形式的场外交流。"]],
    [7, ['speak', {player: 6, content: "那我去6号L拆弹房间, 2号你去3号S拆弹房间吧,那么那里的钥匙就是你的了。"}]],
    // R1 move
    ...
    [6, ['notice', "允许玩家言行不一。移动阶段必须走出所在房间，但【大厅】例外，允许无条件停留。"]],
    ...
    [6, ['speak', {player: 4, content: "刚才我听到6号要去拆弹,于是我就没去了, 因为我要是去拆弹的话主要我是想拿到钥匙。"}]],
    [8, ['speak', {player: 4, content: "我如果刚才到6号L房间的话我的号码比不上6号大, 所以我在最后移动的时候选择留在大厅观察情况"}]],
    [4, ['speak', {player: 4, content: "这回合我可以首先移动, 我想我会去拿线索。"}]],
    [1, ['update', {"round":2,"stage":"speak","room":0,"player":1,"time":80,"bomb":1}]],
    [8, ['speak', {player: 5, content: "我的想法和6号差不多,现在拆了一次弹,不如我们再去拆另外一次吧, 这样子我们就有多一回合的逃生时间了。"}]],
    [4, ['speak', {player: 5, content: "其它什么的，我是好人，我听你们的安排吧。"}]],
    [1, ['update', {"round":2,"stage":"speak","room":3,"player":0,"time":80,"bomb":1}]],
    [12, ['speak', {player: 2, content: "我和1号玩家都有锁匙，我想我们应该利用时间差，尽快解开关键的线索和治疗房间，我一会儿会移动到7号房间解锁，然后1号你就可以移动2步到8号治疗房间解锁，同时也可以治疗自己。"}]],
    [1, ['update', {"round":2,"stage":"speak","room":4,"player":0,"time":80,"bomb":1}]],
    [4, ['speak', {player: 1, content: "我同意2号的说法，这样子我们就可以多获得线索的同时解毒了。"}]],
    [3, ['speak', {player: 1, content: "2号提出了这个优质的方案，我想他应该是好人。"}]],
    [4, ['speak', {player: 1, content: "另外3号跑进监控房间看我了我线索，是出于对我的不信任吗？"}]],
    [6, ['speak', {player: 1, content: "我刚才拿到的线索卡内容是【3】号房间是最终危险的! 我一会就会去解锁帮助大家。"}]],
    [3, ['think', "如果2号不去解开7号房间的话那我就去解。"]],
    [1, ['update', {"round":2,"stage":"speak","room":5,"player":0,"time":80,"bomb":1}]],
    [8, ['speak', {player: 3, content: "1号我不是不相信你，只是我们当中可能有奸徒的存在，我要多观察你们才能保证团队的安全，我是受害者我要逃出这里！"}]],
    [1, ['update', {"round":2,"stage":"speak","room":6,"player":0,"time":80,"bomb":1}]],
    [7, ['think', "刚才3号看了我的线索卡为什么不说出来确定呢? 3号非常可疑呀! 可是他的发言回合已经结束了，只能下回合提醒他了。"]],
    [8, ['speak', {player: 6, content: "这回合我可以配合大家拆弹，但如果2号和1号都不去解锁的话那我会去7号房间解锁，毕竟线索获得是最重要的事情。"}]],
    // R2 move
    ...
    [5, ['think', "还好6号随机应变没去拆弹，即使去了也会因为人数不够无法拆弹。"]],
    // R3 time
    ...
    [8, ['think', "唯一能与5号配合拆弹的方案就是3号去6号房间，然后6号去3号房间，3人合力拆弹，但是3没去拆弹，导致5号白白浪费行动力！"]],
    ...
    [5, ['speak', {player: 3, content: "我刚才忘了说1号玩家手上的线索卡, 3号房间的确是危险的。"}]],
    [5, ['speak', {player: 3, content: "我想快点跑回大厅告诉大家这个消息，没想到刚才错过了拆弹的时机。"}]],
    [1, ['update', {"round":3,"stage":"speak","room":3,"player":0,"time":90,"bomb":1}]],
    [5, ['speak', {player: 5, content: "3号应该就是奸徒了，大家小心点吧，我的行动都被浪费了！"}]],
    [3, ['think', "对，3号肯定就是奸徒了！"]],
    [1, ['update', {"round":3,"stage":"speak","room":4,"player":0,"time":90,"bomb":1}]],
    [4, ['speak', {player: 4, content: "我刚才获得的线索卡是9号房间是最终危险的！"}]],
    [12, ['notice', "你可以点击地图上方的线索区【9】号房间的位置，将其标记为【?】表示该房间可能是危险的，因为奸徒很可能会说谎，而你现在并不能确定谁是奸徒。"]],
    [8, ['speak', {player: 4, content: "3号的确可疑，这回合我觉得应该给一个机会3号，让他和我们配合拆弹，这样子就可以证明自己了。"}]],
    [1, ['update', {"round":3,"stage":"speak","room":7,"player":0,"time":90,"bomb":1}]],
    [4, ['speak', {player: 2, content: "我刚才获得的线索卡是2号房间是最终危险的！"}]],
    [8, ['notice', "你可以点击地图上方的线索区【2】号房间的位置将其标记为【?】。"]],
    [10, ['speak', {player: 2, content: "我想我这回合需要去解毒，另外刚才6号玩家已经监控了我手上的线索，请一会儿在发言的时候确定！不然我们就会当你是另外一个嫌疑人！"}]],
    [1, ['update', {"round":3,"stage":"speak","room":8,"player":0,"time":90,"bomb":1}]],
    [10, ['speak', {player: 1, content: "我们对于谁是奸徒已经大概了解了，接下来再来一次拆弹我们的时间就更多了,我这回合为了不打扰大家的安排，我想我会回到大厅待机。"}]],
    ...
    [12, ['think', "另外，6号会配合大家拆弹吗? 如果3号去破坏的话那6号就会浪费行动力了,还有一个房间未解锁,他应该去解锁同时解毒会比较好,我刚才应该多说几句指明情况的，只可惜不能再发言了!"]],
    // R3 move
    ...
    [5, ['think', "拆弹的人数不够，看来我要赶快获得更多的线索才行"]],
    ...
    [7, ['speak', {player: 1, content: "4号，你可以和我去升级Lv2线索卡，有1号L升级房间和2号S升级房间都可以去进行升级。"}]],
    [3, ['think', "趁这个机会，可以考验下4号。"]],
    [8, ['speak', {player: 1, content: "如果到1号L房间则升级后的卡片由4号获得，如果到2号S房间就是小号码的我获得，4号你选一个房间吧。"}]],
    [1, ['update', {"round":4,"stage":"speak","room":3,"player":0,"time":100,"bomb":1}]],
    [1, ['speak', {player: 3, content: "大家忽略我了吗？"}]],
    [5, ['speak', {player: 3, content: "我刚才已经听大家的安排去拆弹房间了，为什么大家不配合我的行动呀？"}]],
    [3, ['speak', {player: 3, content: "现在这样子不是浪费了我和4号的行动力了吗？"}]],
    [2, ['speak', {player: 3, content: "我是无辜的受害者呀！"}]],
    [5, ['speak', {player: 3, content: "现在只有我没有线索卡了，我要到4号线索房间拿线索帮助大家。"}]],
    [2, ['speak', {player: 3, content: "我会用行动证明我是好人！"}]],
    [1, ['update', {"round":4,"stage":"speak","room":3,"player":1,"time":100,"bomb":1}]],
    [7, ['speak', {player: 4, content: "1号我要到1号L升级房间，因为我知道我自己的身份肯定是受害者，线索要拿在自己手上才是最安全的。"}]],
    [12, ['speak', {player: 4, content: "希望你配合我到1号房间升级，升级完成后下一回合你可以到4号房间再拿线索，如果不升级的话你可以考虑去5号房间监控3号的线索，反正你也不信他。"}]],
    [3, ['think', "监控3号固然重要，但现在升级更重要。"]],
    [1, ['update', {"round":4,"stage":"speak","room":7,"player":0,"time":100,"bomb":1}]],
    [4, ['speak', {player: 5, content: "我刚才获得的线索卡是7号房间是最终危险的！"}]],
    [5, ['notice', "你可以将【7】号房间标记为【?】"]],
    [3, ['speak', {player: 5, content: "这回合如果我不解毒就没时间去了,我要去治疗。"}]],
    [7, ['speak', {player: 5, content: "1号你可以去监控一下我的线索卡，不过现在奸徒很明显出来了，除了3号的线索外其它人都基本不需要看了!"}]],
    [1, ['update', {"round":4,"stage":"speak","room":8,"player":0,"time":100,"bomb":1}]],
    [4, ['speak', {player: 2, content: "我回大厅待机，下回合看情况我也要升级线索卡。"}]],
    [1, ['update', {"round":4,"stage":"speak","room":11,"player":0,"time":100,"bomb":1}]],
    [15, ['speak', {player: 6, content: "我是最后一个发言归票的，我先解释一下刚才的行为，我不去拆弹而去解毒的原因很简单，就是我不想3号来破坏行动，大家看看，3号到现在都没有解毒，因为奸徒是不需要解毒的！所以为了保证我自己存活所以我首先选择治疗我自己。"}]],
    [5, ['speak', {player: 6, content: "所以为了保证我自己存活，我首先选择治疗我自己。"}]],
    [7, ['speak', {player: 6, content: "刚才上一回合我看到2号手上的Lv1线索的确是2号房间是危险的，大家最后不要到2号房间。"}]],
    [10, ['notice', "【2】号房间被第二位玩家证实是危险的，可以点击线索区，将其标记为【X】，表示确定危险。(游戏中最多只有一个奸徒，不可能两个人同时说谎)"]],
    [7, ['speak', {player: 6, content: "这一回合呢？...我想我会去9号房间看一下3号拿的卡，3号你可不要轻举妄动哦！"}]],
    ...
    [10, ['speak', {player: 2, content: "这回合我可以升级，而且选择比较多，如果和4号去升级的话就会得出Lv3线索卡，如果和3号去升级的话就会得出Lv2线索卡。"}]],
    [7, ['speak', {player: 2, content: "大家都对3号非常怀疑，但我觉得3号这二个回合的表现还好，所以我想听听大家的意见。"}]],
    [7, ['think', "Lv3的线索信息量比Lv2的要高，肯定升级Lv3的好，而且升级Lv2要和3号配合, 2号脑子坏了?"]],
    [1, ['update', {"round":5,"stage":"speak","room":1,"player":0,"time":110,"bomb":1}]],
    [5, ['speak', {player: 4, content: "我刚才获得的Lv2线索卡是【蓝色】房间是最终危险的！"}]],
    [8, ['notice', "【2】级线索卡，可以用来排除某一种颜色，每种颜色都有3个房间，因此可以一次性排除3个不安全的房间。"]],
    [10, ['speak', {player: 4, content: "这样子我们一下子就排除了2号、5号、12号三个蓝色房间，2号房间之前由Lv1线索卡得知是危险房间，现在更进一步肯定了。"}]],
    ...
    [8, ['speak', {player: 1, content: "3号如果你是好人的话一会儿就马上说出你手上的线索卡，如果你不说的话2号就会去5号房间监控你的线索。"}]],
    [4, ['speak', {player: 1, content: "这回合我会到4号房间再拿一张Lv1线索卡的。"}]],
    [1, ['update', {"round":5,"stage":"speak","room":4,"player":0,"time":110,"bomb":1}]],
    [5, ['speak', {player: 3, content: "我刚才获得的Lv1线索卡是5号房间是最终危险的！"}]],
    [5, ['notice', "你可以将【5】号房间标记为【X】"]],
    [8, ['speak', {player: 3, content: "大家要相信我，这回合我可以和大家一起升级Lv2线索卡，如果大家不信我那我只能去解毒了。"}]],
    [12, ['think', "5号房间已经在刚才的Lv2线索卡中排除，3号这张线索卡没有任何用处！不过就算是他谎报的话也是漏掉线索，并没有提供错误的线索，这样子暂时可以先不用监控他。"]],
    [1, ['update', {"round":5,"stage":"speak","room":7,"player":0,"time":110,"bomb":1}]],
    [4, ['speak', {player: 6, content: "我的线索卡是【1】号房间危险。"}]],
    [5, ['notice', "你可以将【1】号房间标记为【?】"]],
    [6, ['speak', {player: 6, content: "3号的卡如果是5号房间就不需要看了，现在更重要的监控Lv3的高级线索卡。"}]],
    [3, ['speak', {player: 6, content: "3号你如果不是奸徒就去解毒吧！"}]],
    [4, ['speak', {player: 6, content: "5号你去看一下升级出来的Lv3线索。"}]],
    [1, ['update', {"round":5,"stage":"speak","room":11,"player":0,"time":110,"bomb":1}]],
    [7, ['speak', {player: 5, content: "没问题，有了Lv3线索我们就很快会知道最后的答案了，我到9号房间去监控一下。"}]],
    // R5 move
    ...
    [1, ['update', {"round":6,"stage":"perform","room":2,"player":0,"time":15,"bomb":1}]],
    ...
    [8, ['speak', {player: 6, content: "我们的升级好了，大家做得好！我要听一下2号的Lv3线索卡内容来决定这最后一次行动的计划。"}]],
    [1, ['update', {"round":6,"stage":"speak","room":2,"player":0,"time":120,"bomb":1}]],
    [5, ['speak', {player: 2, content: "我刚才获得的Lv3线索卡是【无锁】的房间是最终危险的！"}]],
    [12, ['notice', "【3】级线索卡会显示【有锁】还是【无锁】的房间是危险的，12个房间中，6个有锁(锁上或者打开状态都视为有锁)，6个没有锁，因此可以一次性排除6个不安全的房间。"]],
    [6, ['speak', {player: 2, content: "这样子我们一下就排除了3号、4号、6号、9号、10号、12号房间。"}]],
    [5, ['speak', {player: 2, content: "原来的3号、9号是通过Lv1排除，而12号房间是通过Lv2排除。"}]],
    [10, ['notice', "你可以将【9】号、【12】号房间标记为【X】，【4】号、【6】号、【10】号房间标记为【?】"]],
    [15, ['speak', {player: 2, content: "通过Lv1和Lv2与Lv3进行线索叠加，我们我们推理得出3号、9号和12号肯定不是最后的安全房间，而一会如果5号证实我手上的Lv3的话那剩余的4号、6号和10号房间都不是最后的安全房间。"}]],
    [4, ['speak', {player: 2, content: "那么安全房间的可能就剩余8号和11号房间了！"}]],
    [10, ['think', "2号完美的推理呀！我刚才获得的Lv1线索卡的内容就是8号房间是危险的，只要我说出来，那真相就出现了！最后的答案就是11号房间是最终的安全房间！"]],
    [1, ['update', {"round":6,"stage":"speak","room":2,"player":1,"time":120,"bomb":1}]],
    [12, ['speak', {player: 4, content: "咳！咳！我没有解毒，看来我要死在这里了，我为团队做的贡献大家要记住，剩余8号和11号房间，我想我临死之前再去4号房间拿一张线索卡好了。"}]],
    [1, ['update', {"round":6,"stage":"speak","room":4,"player":0,"time":120,"bomb":1}]],
    [5, ['think', "终于轮到我发言了，谜底即将揭开，我们将要逃出这可恶的密室！"]],
    [7, ['speak', {player: 1, content: "我刚才获得的Lv1线索卡是8号房间是最终危险的！也就是说11号房间就是最终的出口！"}]],
    [3, ['speak', {player: 1, content: "现在大家集中到大厅然后逃走吧！"}]],
    [2, ['speak', {player: 1, content: "天堂的出口就是眼前！"}]],
    [2, ['speak', {player: 1, content: "11号房间是安全出口！"}]],
    [1, ['speak', {player: 1, content: "11号房间是安全出口！"}]],
    [1, ['update', {"round":6,"stage":"speak","room":9,"player":0,"time":120,"bomb":1}]],
    [6, ['speak', {player: 5, content: "想不到答案这么快就出现了，2号的线索卡的确是【无锁】危险。"}]],
    [8, ['notice', "你可以将【4】号、【6】号、【10】号房间标记为【X】"]],
    [6, ['speak', {player: 5, content: "但我们现在还有3张线索没有监控到，而且贡献最大的4号还没有解毒。。。"}]],
    [6, ['speak', {player: 5, content: "对了，我们可以再次拆弹，这样子我们就有足够的时间监控和解毒了。"}]],
    [10, ['speak', {player: 5, content: "3号奸徒距离不够不能来破坏拆弹了，建议1号和6号跟我一起拆弹，2，3负责监控，4号先去拿张线索卡，等我们拆弹成功就有时间解毒了"}]],
    [3, ['speak', {player: 5, content: "这样我们大家都能逃走了！"}]],
    [1, ['update', {"round":6,"stage":"speak","room":11,"player":0,"time":120,"bomb":1}]],
    [8, ['speak', {player: 3, content: "这计划好是好，但是如果失败了，大家就都逃不掉了，大家还是回大厅集中然后逃走吧！我是受害者！"}]],
    [4, ['think', "5号的方案非常好，3号你这次破坏不了了！"]],
    // R6 move
    ...
    [1, ['update', {"round":7,"stage":"perform","room":3,"player":0,"time":15,"bomb":1}]],
    ...
    [7, ['think', "杯具了！拆弹竟然失败了。。奸徒就在5号和6号之中！没时间了！我们没时间到达安全房间了！！！"]],
    ...
    [8, ['challenge', {question: 'watch', player: 3, time: 15}]],
    ...
    [7, ['speak', {player: 1, content: "天呐！拆弹居然失败了！5号！6号！奸徒就在你们两个当中！到底是谁？"}]],
    [8, ['speak', {player: 1, content: "现在除了3号能到达11号安全房间外，其它人都要死在这里了！3号居然是受害者！"}]],
    [3, ['think', "思想一片混乱..."]],
    [1, ['update', {"round":7,"stage":"speak","room":3,"player":1,"time":130,"bomb":-2}]],
    [9, ['speak', {player: 6, content: "我是受害者，我们都被骗过来拆弹了！好后悔刚才没有听3号的话回大厅集中，现在我们都要死在这里了！"}]],
    [1, ['update', {"round":7,"stage":"speak","room":4,"player":0,"time":130,"bomb":-2}]],
    [3, ['speak', {player: 4, content: "咳咳，大家都中了调虎离山之计？"}]],
    [5, ['speak', {player: 4, content: "我刚才获得的Lv1线索卡是13号房间是最终危险的！"}]],
    [8, ['notice', "密室中没有【13】号房间，不过“【13】号房间危险”这张线索卡在6人+局中是有的，无用线索卡用来增加难度。"]],
    [10, ['speak', {player: 4, content: "这个密室里那里有13号房间呀？13号房间在那里呀？！会是出口吗？抽到这个线索卡难道是团队覆灭的暗示吗？"}]],
    [1, ['update', {"round":7,"stage":"speak","room":5,"player":0,"time":130,"bomb":-2}]],
    [8, ['speak', {player: 2, content: "我刚才看了5号的线索卡，他手上的确是7号房间是危险的...，但我们已经无力回天了..."}]],
    [5, ['notice', "你可以将【7】号房间标记为【X】"]],
    [1, ['update', {"round":7,"stage":"speak","room":6,"player":0,"time":130,"bomb":-2}]],
    [8, ['speak', {player: 5, content: "奸徒是1号，他一直在误导我们进行错误的行动，还冤枉3号是奸徒，我看他自己就是奸徒！"}]],
    [12, ['think', "奸徒是5号！可惜我们互相质疑耽误了时间，密室的目标在于找出安全房间，找到奸徒我们如果不能逃生的话又有什么意义呢？如果当时能再认真想一下的话现在的局面就不会这样子了!"]],
    [9, ['speak', {player: 5, content: "他手上的Lv1线索卡指向8号房间，是唯一没有验证过的，8号房间才是安全房间，可惜呀~我们都不去了啦！"}]],
    [1, ['update', {"round":7,"stage":"speak","room":9,"player":0,"time":130,"bomb":-2}]],
    [4, ['speak', {player: 3, content: "错过了刚才最佳的移动时机，机会走了就不会再有了！"}]],
    [12, ['speak', {player: 3, content: "开始时我的移动是有些混乱，但我在后面可是全力配合大家的，但你们就是没人配合我导致行动力浪费，没有进行完全的团队合作就是我们失败的地方！"}]],
    [5, ['speak', {player: 3, content: "现在只有我一个人能活着，但我们受害者团队失败了！"}]],
    [5, ['speak', {player: 3, content: "对了，我刚看了6号的卡，他没说谎，1号房间危险。"}]],
    [5, ['notice', "你可以将【1】号房间标记为【X】"]],
    [3, ['think', "哎..."]],
    // R7 move
