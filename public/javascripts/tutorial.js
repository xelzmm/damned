...
var scripts = [
    ...
    [5, ['notice', "获得房间功能执行权的玩家，可以同时获得房间内的钥匙，并永久持有。"]],
    [1, ['update', {"round":2,"stage":"perform","room":3,"player":0,"time":3,"bomb":0}]],
    [3, ['challenge', {participants: [2,6], question: 'action', options: {masterPlayer: 2, actionType: 'disarm'}, time: 15}]],
    [4, ['notice', "拆弹需要两个拆弹房间都有人，且总人数满足一定条件，才可以发起。"]],
    [5, ['notice', "游戏总人数不同，拆弹需要的人数也不同，游戏区右下角的拆弹面板会有具体人数的提示。"]],
    [5, ['notice', "拆弹时，受害者只能【配合】，成功拆弹两次，游戏将增加一回合。"]],
